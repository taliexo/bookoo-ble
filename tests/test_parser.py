"""Tests for Bookoo BLE parser logic."""
from unittest.mock import MagicMock
import pytest

from custom_components.bookoo_ble.parser import BookooBluetoothParser
from custom_components.bookoo_ble.helpers import generate_checksum_byte, validate_checksum
...
class TestWeightNotification:
    ...
    def test_parse_weight_notification_valid(self):
        ...
        result = BookooBluetoothParser._parse_weight_notification(data)
    ...
    def test_parse_weight_notification_invalid_type(self):
    ...
    def test_parse_weight_notification_invalid_checksum(self):
...
class TestStatusNotification:
    ...
    def test_parse_status_notification_timer_started(self):
        ...
        result = BookooBluetoothParser._parse_status_notification(data)
        assert result is not None
    ...
    def test_parse_status_notification_too_short(self):
        """Test parsing status notification with too short data."""
        data = bytes.fromhex("030d01")
        result = BookooBluetoothParser._parse_status_notification(data)
        assert result is None

    def test_parse_status_notification_wrong_product_id(self):
    ...
    def test_parse_status_notification_wrong_identifier(self):
...
class TestParseNotification:
    ...
    def test_parse_notification_weight(self):
        ...
        result = BookooBluetoothParser.parse_notification(data)
        assert result is not None
        assert result["message_type"] == "weight"
    ...
    def test_parse_notification_too_short(self):
        """Test parsing notification that is too short."""
        data = bytes([0x01])
        result = BookooBluetoothParser.parse_notification(data)
        assert result is None
